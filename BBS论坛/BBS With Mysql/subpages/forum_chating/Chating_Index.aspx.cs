...
public partial class subpages_forum_chating_Chating_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //else if (Session["usergroup"].ToString() == "灌水区版主")
        //{
        //    GridView1.Columns[4].Visible = true;
    ...
    {
        GridView1.DataSource = da.ExecuteDateSet("select * from Posts where type='灌水' order by time desc");
