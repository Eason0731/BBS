<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-forum.aspx.cs" Inherits="admin_forum_manage_add_forum" %>
        ...
        <table border="0" width="50%">
            <tr>
                ...
                <td width="60%">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txt论坛名" ErrorMessage="论坛名不能为空！" ValidationGroup="group1"></asp:RequiredFieldValidator>
                    </label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <label>
                                        <label>
                    <asp:TextBox ID="txt版块简介" runat="server" TextMode="MultiLine" Height="200px" Width="400px"></asp:TextBox>
                    </label>
                
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="txt论坛简介" ErrorMessage="论坛简介不能为空！" ValidationGroup="group1"></asp:RequiredFieldValidator>
                    </label>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div align="center">
                        <br />
                        <asp:Button ID="btn新增" runat="server" onclick="btn新增_Click" Text="新增" ValidationGroup="group1"/>
                        &nbsp;
