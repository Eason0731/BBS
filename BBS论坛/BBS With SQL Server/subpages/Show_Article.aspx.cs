...
public partial class subpages_Show_Article : System.Web.UI.Page
{
    ...
    protected void ShowComments() 
    {
        ...
        SqlDataAdapter oda = new SqlDataAdapter("select ROW_NUMBER() over (order by [time]) +1 as floorid,* from Comments join Users on Comments.username=Users.username where postid ='" + Request["id"] + "' order by [time] asc", con);
    ...
    protected void Button1_Command(object sender, CommandEventArgs e)
    {
        ...
        if (Session["name"]!= null)
        {
            ...
            if (e.CommandName == "DeleteFloor")
            {
                    ...
                    SqlDataReader dadel = da.ExecuteRead(strDel);
    ...
    protected void LB置顶_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlDataReader sdr = da.ExecuteRead(sql_zd);
    ...
    protected void LinkButton5_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader sdr = da.ExecuteRead(sqlstring); //踩+1
        Response.Write("<script>window.location.href=window.location.href;</script>");
    }
}