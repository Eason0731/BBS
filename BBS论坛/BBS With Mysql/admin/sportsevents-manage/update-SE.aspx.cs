...
public partial class admin_sportsevents_manage_update_SE : System.Web.UI.Page
{
    ...
    protected void UploadButton_Click(object sender, EventArgs e)
    {
        ...
        if (type == ".jpg" || type == ".gif" || type == ".bmp" || type == ".png")
        {
            ...
            string SEImages = this.Image1.ImageUrl;

            //string sql = "update Sports_Event Set images='~\\images\\SE\\" + name + "' WHERE ID = '" + Request.QueryString["id"] + "'"; Old for MSSQL
            string sql = "update Sports_Event Set images='" + SEImages + "' WHERE ID = '" + Request.QueryString["id"] + "'";
