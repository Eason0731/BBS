...
public partial class subpages_forum_notice_Notice_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ((Button)Page.Master.FindControl("Btn发帖")).Visible = true;
    ...
    {
        GridView1.DataSource = da.ExecuteDateSet("select * from Posts where type='公告' order by time desc");
