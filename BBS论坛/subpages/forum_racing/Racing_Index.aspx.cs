...
public partial class subpages_forum_racing_Racing_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //else if (Session["usergroup"].ToString() == "赛车区版主")
        //{
        //    GridView1.Columns[4].Visible = true;
    ...
    {
        GridView1.DataSource = da.ExecuteDateSet("select * from Posts where type='赛车' order by time desc");
