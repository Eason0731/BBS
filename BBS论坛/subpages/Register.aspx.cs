...
public partial class subpages_Register : System.Web.UI.Page
{
    ...
    protected void btn注册_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            connection.Close();
            connection.Open();
            mycommand.CommandText = "insert into Users(username,password,sex,age,usergroup,iconpath,jifen) values('" + txt用户名.Text + "','" + txt密码.Text + "','" + ddl性别.Text + "','" + txt年龄.Text + "','普通用户','~\\images\\icons\\default_icon.jpg','0')";
