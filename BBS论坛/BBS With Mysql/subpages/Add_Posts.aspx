<%@ Page Title="发布新帖子" Language="C#" MasterPageFile="~/subpages/MasterPage-subpage.master" AutoEventWireup="true" CodeFile="Add_Posts.aspx.cs" Inherits="subpages_Add_Posts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    发布新帖子-<asp:Label ID="lblType" runat="server" Text="Label"></asp:Label>
</asp:Content>
...
<tr>
      ...
      <asp:TextBox id="txt内容" cols="100" rows="8" style="width:700px;height:200px;" runat="server"></asp:TextBox>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                  ControlToValidate="txt内容" ErrorMessage="内容不能为空！" 
                  ValidationGroup="ValidataGroup1"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="2">
            <div align="center">
                ...
                <asp:Button ID="btn发表" runat="server" Text="发表" onclick="btn发表_Click" ValidationGroup="ValidataGroup1"/>
