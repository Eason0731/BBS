...
public partial class subpages_forum_basketball_Basketball_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //else if(Session["usergroup"].ToString()=="篮球区版主")
        //{
        //    GridView1.Columns[4].Visible = true;
    ...
    {
        GridView1.DataSource = da.ExecuteDateSet("select * from Posts where type='篮球' order by time desc");
