...
public partial class index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        /*显示最新帖子和最新回复的方法*/
        string sql1 = "select top 6 * from Posts order by time desc "; //最新帖子
        SqlDataReader dr_newpost = da.ExecuteRead(sql1);
        DDL最新帖子.DataSource = dr_newpost;
        DDL最新帖子.DataKeyField = "id";
        DDL最新帖子.DataBind();
        dr_newpost.Close();

        string sql2 = "select top 6 Comments.username As HFYH,Comments.time As HFSJ,* from Posts join Comments on Posts.ID=Comments.postid order by HFSJ desc"; //最新回复
        SqlDataReader dr_newcommand = da.ExecuteRead(sql2);
